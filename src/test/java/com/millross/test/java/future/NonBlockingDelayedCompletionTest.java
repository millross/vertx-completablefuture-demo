...
public class NonBlockingDelayedCompletionTest {

    @Rule
    public final RunTestOnContext rule = new RunTestOnContext();

    @Test
    public void testNonBlockingDelayedCompletion(TestContext context) {
        ...
        vertx.setTimer(500, i -> toComplete.complete(100));
        toComplete.thenRun(() -> {
